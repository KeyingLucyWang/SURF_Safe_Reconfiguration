...
class VehiclesAhead(BasicScenario):
    ...
    def _setup_scenario_trigger(self, config):
        ...
        if config.trigger_points and config.trigger_points[0]:
            start_waypoint, _ = get_waypoint_in_distance(config.trigger_points[0], 10)
    ...
    def _initialize_actors(self, config):
        ...
        while num_actors >= 0:
            vehicle_location = actor_list[num_actors]["location"]
    ...
    def _create_behavior(self):
        ...
        while num_actors < self._num_actors:
            ...
            start_transform = ActorTransformSetter(self.other_actors[num_actors], self._other_actor_transform)
            ...
            driving_to_next_intersection.add_child(WaypointFollower(self.other_actors[num_actors], self._first_vehicle_speed))
            ...
            endcondition_part1 = InTriggerDistanceToVehicle(self.other_actors[num_actors],
                                                            self.ego_vehicles[0],
                                                            distance=20,
                                                            name="FinalDistance")
            endcondition_part2 = StandStill(self.ego_vehicles[0], name="StandStill", duration=5)
